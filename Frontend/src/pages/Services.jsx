      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className={cardStyle}>
            <div className="w-10 h-10 bg-orange-500/10 rounded-lg flex items-center justify-center mb-6 border border-orange-500/20 group-hover:bg-orange-500/20 transition-colors">
          ...
          {/* Bottom Left */}
          <div className={cardStyle}>
            <h2 className="text-white text-2xl font-bold mb-4">Why Me?</h2>
            <p className="text-gray-400 leading-relaxed mb-6">
              Because average websites don’t grow businesses. <br /><br />
              - I build to stand out <br />
              - I build to perform <br />
              - I build with intent
            </p>
            <span className="text-xs font-extrabold text-orange-500">
